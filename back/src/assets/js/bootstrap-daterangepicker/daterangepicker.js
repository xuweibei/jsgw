...
'<div class="prev_year"><i class="glyphicon glyphicon-arrow-left"></i></div>'+
'<div class="calendar-table">'+
'</div>'+
'</div>'+
'<div class="calendar right">'+
'<div class="prev_month"><i class="glyphicon glyphicon-arrow-right"></i></div>'+
...
html+='<th></th>';if((!minDate||minDate.isBefore(calendar.firstDay))&&(!this.linkedCalendars||side=='left')){html+='<th class="prev available"><i class="glyphicon glyphicon-arrow-left"></i></th>';}else{html+='<th></th>';}
...
html+='<th colspan="5" class="month">'+dateHtml+'</th>';if((!maxDate||maxDate.isAfter(calendar.lastDay))&&(!this.linkedCalendars||side=='right'||this.singleDatePicker)){html+='<th class="next available"><i class="glyphicon glyphicon-arrow-right"></i></th>';}else{html+='<th></th>';}
